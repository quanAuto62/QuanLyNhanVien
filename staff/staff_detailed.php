                                                            ...
                                                            <form class="md-float-material">
                                                                ...
                                                                <div class="auth-box card-block">
                                                                    <div class="row m-b-20">
                                                                        <div class="col-md-12">
                                                                            <h5 class="text-center txt-primary">Quản Lý Người Giám Sát <strong><?php echo htmlspecialchars($row['first_name'] . ' ' . $row['middle_name'] . ' ' . $row['last_name']); ?></strong></h5>
                                                                        </div>
                                                                    </div>
                                                                    <hr>
                                                                    <select name="supervisor" class="form-control form-control-info">
                                                                        <option value="">Chỉ được chọn 1</option>
                                                                        <?php
                                                                            $employeeId = $row['emp_id'];
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-10">
                                                                            <p class="text-inverse text-left m-b-0">Bạn có thể chỉ định người giám sát cho từng nhân viên.</p>
                                                                            <p class="text-inverse text-left"><b>Hãy lựa chọn đúng.</b></p>
                                                                        </div>
                                                                        <div class="col-md-2">
                                    ...
                                    <div class="login-card card-block login-card-modal">
                                        <form class="md-float-material">
                                            <div class="card m-t-15">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <p class="text-inverse text-left"><b>Bạn sẽ cần xác thực sau khi thay đổi mật khẩu.</b></p>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
