                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                   <input type="password" id="new_password" name="new_password" class="form-control password" required="" placeholder="Mật khẩu mới">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button id="reset-password" type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20"><i class="icofont icofont-lock"></i> Reset mật khẩu </button>
                                    </div>
                                </div>
                                
                                <p class="text-inverse text-right">Trở lại <a href="index1.php">đăng nhập</a></p>
...
<!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    $('#reset-password').click(function(event){
        ...
        if (newPassword.trim() === '' || confirmPassword.trim() === '') {
            Swal.fire({
                icon: 'warning',
                text: 'hãy nhập đầy đủ các trường',
