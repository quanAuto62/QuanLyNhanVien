                                                ...
                                                <div class="card-block">
                                                    <div class="row">
                                                        <div class="col-sm-6 mobile-inputs">
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="userName-2" class="block">Chỉ định</label>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <select class="js-example-disabled-results col-sm-12" name="assigned_to" id="assigned_to" required>
                                                                            ...
                                                                            if (!empty($row['assigned_to'])) {
                                                                                ...
                                                                                echo '<option value="" disabled selected>Lựa Chọn Nhân Viên</option>';
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <?php else: ?>
                                                                <button id="tasks-add" type="submit" class="btn btn-primary m-b-0">Xác Nhận</button>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        $('#tasks-update').click(function(event){
            ...
            (async () => {
                ...
                console.log("Ngày kết thúc: " + dueDate);
    ...
    <script>
        ...
        $('#tasks-add').click(function(event){
            ...
            (async () => {
                ...
                console.log("Ngày bắt đầu: "+ $('#dropper-animation').val())
