                                            ...
                                            <!-- Task-detail-right start -->
                                             <div class="col-xl-4 col-lg-12 push-xl-8 task-detail-right">
                                                <div class="card">
                                                    ...
                                                    // Xác định xem các tùy chọn chỉnh sửa và xóa có được hiển thị hay không
                                                            ...
                                                            <div>
                                                                <div class="dropdown-secondary dropdown d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdown3" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                        <a class="dropdown-item waves-light waves-effect" href="new_task.php?id=<?= $id ?>&edit=1"><i class="icofont icofont-edit-alt m-r-10"></i>Chỉnh Sửa Nhiệm Vụ</a>
                                                        ...
                                                        <div class="f-right">
                                                            <div class="dropdown-secondary dropdown">
                                                                <button id="status-dropdown" class="btn btn-sm btn-primary dropdown-toggle waves-light" type="button" id="dropdown2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <?php echo $row['status'] == "Đang Chờ" ? 'Đang Chờ' : ($row['status'] == "Đang Thực Hiện" ? 'Đang Thực Hiện' : ($row['status'] == "Đã hoàn thành" ? 'Đã hoàn thành' : 'Đang Chờ')); ?>
                                                                </button>
                                                                <?php if ($_SESSION['srole'] === 'Admin' || $_SESSION['srole'] === 'Manager' || $row['assigned_by'] == $_SESSION['slogin']): ?>
                                                                    <div class="dropdown-menu" aria-labelledby="dropdown2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                        <a class="dropdown-status dropdown-item waves-light waves-effect <?php echo $row['status'] == "Đang Chờ" ? 'active' : ''; ?>" href="#!" data-status="Đang Chờ" data-task-id="<?php echo $row['id']; ?>">Đang Chờ</a>
                                                                        <a class="dropdown-status dropdown-item waves-light waves-effect <?php echo $row['status'] == "Đang Thực Hiện" ? 'active' : ''; ?>" href="#!" data-status="Đang Thực Hiện" data-task-id="<?php echo $row['id']; ?>">Đang Thực Hiện</a>
                                                                        <a class="dropdown-status dropdown-item waves-light waves-effect <?php echo $row['status'] == "Đã hoàn thành" ? 'active' : ''; ?>" href="#!" data-status="Đã hoàn thành" data-task-id="<?php echo $row['id']; ?>">Đã hoàn thành</a>
                                                                    </div>
                                                                <?php endif; ?>
                                                                <!-- end of dropdown menu -->
                                                            </div>
