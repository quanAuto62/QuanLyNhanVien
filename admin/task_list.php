                                                    ...
                                                    <div class="card-block p-t-10">
                                                        <div class="task-right">
                                                            <div class="task-right-header-status">
                                                                <span data-toggle="collapse">Cấp Độ Nhiệm Vụ</span>
                                                ...
                                                <nav class="navbar navbar-light bg-faded m-b-30 p-10">
                                                    <ul class="nav navbar-nav">
                                                        <li class="nav-item active">
                                                            <a class="nav-link" href="#!">Bộ lọc: <span class="sr-only">(current)</span></a>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle" href="#!" id="bydate" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icofont icofont-clock-time"></i> Theo Ngày</a>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="bystatus">
                                                                ...
                                                                <a class="dropdown-item <?php echo isset($_GET['status']) && $_GET['status'] === '' ? 'active' : ''; ?>" href="?status=Completed">Completed</a>
                                                            </div>
                                                        </li>
                                                                            ...
                                                                            <div class="task-board" style="margin-bottom: 10px;">
                                                                                <div class="dropdown-secondary dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu" aria-labelledby="dropdown1" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                                        <a class="dropdown-priority dropdown-item waves-light waves-effect <?php echo $result['priority'] == 'High' ? 'active' : ''; ?>" href="#!" data-priority="High" data-task-id="<?php echo $result['id']; ?>"><span class="point-marker bg-warning"></span>Cấp độ: High</a>
                                                                                        <a class="dropdown-priority dropdown-item waves-light waves-effect <?php echo $result['priority'] == 'Medium' ? 'active' : ''; ?>" href="#!" data-priority="Medium" data-task-id="<?php echo $result['id']; ?>"><span class="point-marker bg-success"></span>Cấp độ: Medium</a>
                                                                                        <a class="dropdown-priority dropdown-item waves-light waves-effect <?php echo $result['priority'] == 'Low' ? 'active' : ''; ?>" href="#!" data-priority="Low" data-task-id="<?php echo $result['id']; ?>"><span class="point-marker bg-info"></span>Cấp độ: Low</a>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="dropdown-secondary dropdown">
                                                                                ...
                                                                                <div class="dropdown-secondary dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu" aria-labelledby="dropdown3" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                                        <a class="dropdown-item waves-light waves-effect" href="new_task.php?id=<?php echo $result['id']; ?>&edit=1"><i class="icofont icofont-ui-edit"></i> Chỉnh Sửa Nhiệm Vụ</a>
                                                                                        <div class="dropdown-divider"></div>
                    ...
                    if (formValues) {
                        ...
                        $.ajax({
                            ...
                            error: function(xhr, status, error) {
                                ...
                                console.log('Data HERE: ' + JSON.stringify(data));
                                Swal.fire('error', 'Không thể cập nhật cấp độ.', 'error');
                            }
        ...
        $(document).ready(function() {
            $(document).on('click', '.dropdown-status', function(event) {
                ...
                (async () => {
                    const { value: formValues } = await Swal.fire({
                        title: 'Bạn chắc chắn chưa?',
                        text: "Bạn muốn cập nhật trạng thái nhiệm vụ này?",
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        cancelButtonColor: '#d33',
                        confirmButtonText: 'Cập nhật đi!'
                    });
                    ...
                    if (formValues) {
                        ...
                        $.ajax({
                            ...
                            error: function(xhr, status, error) {
                                console.log("AJAX error: " + error);
                                console.log('Data HERE: ' + JSON.stringify(data));
                                Swal.fire('error', 'Không thể cập nhật trạng thái.', 'error');
                            }
            ...
            (async () => {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        console.log("AJAX error: " + error);
                        console.log('Data HERE: ' + JSON.stringify(data));
                        Swal.fire('error', 'Không thể xóa nhiệm vụ.', 'error');
                    }
